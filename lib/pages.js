...
if(Meteor.isServer) {
    ...
    if(Pages.find({}).count() === 0) {
        ...
        Pages.insert({
            page: "home",
            title: "Home",
            content: "<legend>testMan---Welcome to Meteor CMS</legend><p>This is the home page.</p><blockquote><p>The WYSIWYG editor should be completely compatible with Twitter Bootstrap such as in quotes</p><small><cite>Aric Camarata</cite></small></blockquote>",
            url: "/"
        });
